...
1. **Can individuals publish?** The platform exposes Skill creation and submission through its open platform and WorkBuddy's “添加技能 / 创建技能” workflow. The documentation describes providers and developer asset submission without stating an organization-only restriction. A personal developer account still needs to complete whatever identity/profile steps the open platform requests.
