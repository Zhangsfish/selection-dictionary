...
- `CANONICAL_POST_ZH.md` and `CANONICAL_POST_EN.md` are frozen publication sources. Preserve their story, paragraph order, claims, and non-promotional tone.
- `DISTRIBUTION.md` is the canonical ledger of attempted and successful publications. Record durable public URLs and rule-based non-publication outcomes.
